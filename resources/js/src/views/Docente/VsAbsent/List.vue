          ...
          <b-col cols="12" class="d-flex justify-content-between flex-wrap">
            <div>
             ...
             <b-button
              ...
              >
                <b-icon icon="check-lg" aria-hidden="true"></b-icon> Asistencia
              </b-button>
              <!-- <label>Mostrar</label>
              <v-select
                v-model="perPage"
...
export default {
  ...
  setup() {
    ...
    const INVOICE_APP_STORE_MODULE_NAME = "vsabsent";
    ...
    const Listvsabsent = () => {
      ...
      let url = "/vsabsent/records/" + search + "?page=" + state.currentPage;
      axios({
        method: "GET",
        url: url,
      }).then((response) => {
